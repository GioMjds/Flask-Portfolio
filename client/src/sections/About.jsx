...
import { techImagesRight, techImagesLeft } from "../components/Images";
...
const About = () => {
  return (
    <>
        ...
        <div className="about-container grid">
          ...
          <div className="about-data grid">
            ...
            <div className="about-info">
              ...
              <a href={Resume} className="btn" target="_blank">View My Resume</a>
            </div>
      ...
      <Marquee items={techImagesLeft} direction='left' />
    </>
  )
}
